...
|V0.0.1|2024-03-21|테스트2|앨범페이지 필터 서브창 및 검색창 생성/JS 클릭 이벤트처리/버튼 및 아이콘 스타일링/앨범 이미지 레이아웃 조정|
...
|2024-04-01|FE|/css/user/album/main.css|앨범페이지 필터 서브창띄우고 선택(조회순/좋아요 순)|**IMPORTANT**|TRUE|
